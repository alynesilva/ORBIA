...
public class Criar_conta {
	...
	public static void main(String[] args) {
	    ...
	    driver.findElement(By.id("email_create")).sendKeys("marisasilva@orbia.ag");
	    ...
	    driver.findElement(By.id("address1")).sendKeys("Rua do Fogo de Santelmo, Lote 2.07.02 1990 – 110 Lisboa (Junto ao Oceanário)");
	    driver.findElement(By.id("address2")).click();
	    driver.findElement(By.id("address2")).clear();
	    driver.findElement(By.id("address2")).sendKeys("apto");
	    ...
	    driver.findElement(By.id("alias")).sendKeys("addressmarisasilva@orbia.ag");
